...
It.extend( tmpDomMethod );


// 给 It.fn 添加 appendTo, prependTo, insertBefore, insertAfter 方法

It.each( tmpDomMethod, function ( k, v ) {

    It.fn[ k ] = function ( selector ) {
...
It.each( domElementTool, function ( k, method ) {
    It.fn[ k ] = function () {
        // 获得 this 中每一个元素的 k 元素 
        return this.pushStack( It.unique( this.map(function ( v ) {
            return method( v );
        }) ) );
    };
});
