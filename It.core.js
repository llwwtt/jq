...
It.fn = It.prototype = {
    ...
    init: function ( selector ) {
        ...
        // It
        if ( selector.constructor == It ) {
            // return selector; // 在课堂中没有任何问题

            // 保留 this , 但是需要利用 selector 构造一个新的 It 对象
...
It.fn.extend({
    each: function ( callback ) {
        return It.each( this, callback );
    },
    map: function ( callback ) {
        return It.map( this, callback );
    }
});
